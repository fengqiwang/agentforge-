...
import com.agentforge.report.insight.InsightGenerator;
import com.agentforge.report.insight.MarketInsight;
 ...
 * 使用 typed {@link com.agentforge.report.insight.AnalysisResult} 避免反序列化丢类型。
 */
@Slf4j
@Service
...
public class InsightServiceImpl implements IInsightService {
    ...
    public Long generate(String periodType, String start, String end) {
        IAnalysisService.AnalysisOutcome outcome =
