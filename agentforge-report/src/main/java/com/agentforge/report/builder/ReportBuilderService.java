 package com.agentforge.report.builder;
  ...
  public class ReportBuilderService {
      ...
      public Map<String, Object> executeParamSql(String sqlTemplate, Map<String, String> params) {
          ...
          SqlExecutionService.ExecutionResult execResult = executionService.execute(sql);
      ...
      public Map<String, Object> executeReport(String shareToken) {
          ...
          SqlExecutionService.ExecutionResult execResult = executionService.execute(config.getSqlText());
